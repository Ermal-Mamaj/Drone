...
<body>
    <div class="left-controls">
        ...
        <button class="button left-button" onmousedown="sendCommand('left', 'start')" onmouseup="sendCommand('left', 'stop')">Left</button>
        <button class="button right-button" onmousedown="sendCommand('right', 'start')" onmouseup="sendCommand('right', 'stop')">Right</button>
        <button class="button down-button" onmousedown="sendCommand('down', 'start')" onmouseup="sendCommand('down', 'stop')">Down</button>
    </div>
    <div class="right-controls">
        <button class="button forward-button" onmousedown="sendCommand('forward', 'start')" onmouseup="sendCommand('forward', 'stop')">Forward</button>
        <button class="button backward-button" onmousedown="sendCommand('backward', 'start')" onmouseup="sendCommand('backward', 'stop')">Backward</button>
        <button class="button rotate-clockwise" onmousedown="sendCommand('rotate_clockwise', 'start')" onmouseup="sendCommand('rotate_clockwise', 'stop')">Clockwise</button>
        <button class="button rotate-counterclockwise" onmousedown="sendCommand('rotate_counter_clockwise', 'start')" onmouseup="sendCommand('rotate_counter_clockwise', 'stop')">Counterclockwise</button>
    </div>
    ...
    <script>
        ...
        function sendCommand(command, action) {
            if (action === 'start') {
                ...
                }, 100); // Send command every 1 second
            } else if (action === 'stop') {
